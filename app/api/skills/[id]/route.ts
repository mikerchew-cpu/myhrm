...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json({ success: true, data: skill } satisfies ApiResponse);
  } catch (error) {
...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json({ success: true, data: skill, message: "Updated" } satisfies ApiResponse);
  } catch (error) {
